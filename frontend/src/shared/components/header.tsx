        ...
        <header className="px-4 sm:px-6 my-4">
            ...
            <div className="flex items-center justify-between gap-4 pb-3 border-b lg:border-0 lg:pb-0">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <button className="xl:hidden w-9 h-9 flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg transition-colors">
                        ...
                        {showDropdown && (
                            <>
                                ...
                                <div className="absolute right-0 top-full mt-2 w-48 bg-card border border-border rounded-xl shadow-lg z-50 py-2">
                                    <button className="w-full px-4 py-2 text-left text-sm text-muted-foreground hover:text-foreground hover:bg-muted flex items-center gap-3">
                                        <i className="fa-solid fa-user-gear"></i>Mi Perfil
                                    </button>
                                    <button className="w-full px-4 py-2 text-left text-sm text-muted-foreground hover:bg-muted flex items-center gap-3">
            ...
            {/* Actions row */}
            {actions && (
                <div className="flex items-center gap-2 mt-2 overflow-x-auto scrollbar-none border-b pb-2 lg:border-0 lg:pb-0 lg:mt-3 lg:justify-end lg:flex-wrap">
                    {actions}
                </div>
            )}
            ...
            {showMobileMenu && (
                <>
                    ...
                    />
                    <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-card border-t border-border rounded-t-2xl z-50 p-4 space-y-2 animate-in slide-in-from-bottom duration-300">
                        ...
                        <button className="w-full px-3 py-2.5 text-left text-sm text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg flex items-center gap-3 transition-colors">
                            <i className="fa-solid fa-user-gear w-5"></i>Mi Perfil
                        </button>
                        <button className="w-full px-3 py-2.5 text-left text-sm text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg flex items-center gap-3 transition-colors">
                            <i className="fa-solid fa-gear w-5"></i>Configuración
                        </button>
                        <button
                            onClick={handleLogout}
